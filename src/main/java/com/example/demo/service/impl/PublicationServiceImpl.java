...
public class PublicationServiceImpl implements PublicationService {
    ...
    public List<Publication> getPersonalizedRecommendations(String username) {
        ...
        List<RecommendationDTO> recommendations = classificationServiceClient.getPersonalizedRecommendations(upvotedIds, downvotedIds, 1000);
    ...
    public List<Publication> getTopPublications() {
        // The user requested Top to be ordered by total interactions (upvotes + downvotes)
